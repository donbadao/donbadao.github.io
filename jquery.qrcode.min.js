    ...
    var t = function (r, t, e, n) {
        ...
        i = function (t, e, n) {
            ...
            var u = a.measureText(n.label).width,
                ...
                h = g + f,
                v = 0.01;
            1 === n.mode ? t.addBlank(0, g - v, o, h + v) : t.addBlank(c - v, g - v, s + v, h + v), (e.fillStyle = n.fontcolor), (e.font = i), e.fillText(n.label, c * o, g * o + 0.75 * n.mSize * o);
        },
        a = function (r, t, e) {
            var n = e.size,
        ...
        l = function (r, t, e, n, o, i, a, u, f, l) {
            a ? r.moveTo(t + i, e) : r.moveTo(t, e),
                ...
                l ? (r.lineTo(t + i, o), r.arcTo(t, o, t, e, i)) : r.lineTo(t, o),
        ...
        c = function (r, t, e, n, o, i, a, u, f, l) {
            a && (r.moveTo(t + i, e), r.lineTo(t, e), r.lineTo(t, e + i), r.arcTo(t, e, t + i, e, i)),
                ...
                l && (r.moveTo(t + i, o), r.lineTo(t, o), r.lineTo(t, o - i), r.arcTo(t, o, t + i, o, i));
        },
        ...
        s = function (t, e, o) {
            var i,
                ...
                l = o.size / u,
                c = f;
            for (n && o.radius > 0 && o.radius <= 0.5 && (c = g), e.beginPath(), i = 0; u > i; i += 1)
                for (a = 0; u > a; a += 1) {
                    var s = o.left + a * l,
                        h = o.top + i * l,
                        v = l;
        ...
        w = function (t) {
            ...
            var n,
                ...
                c = f(a / l),
                g = f(0.5 * (a - c * l)),
                s = { position: "relative", left: 0, top: 0, padding: 0, margin: 0, width: a, height: a },
                h = { position: "absolute", padding: 0, margin: 0, width: c, height: c, "background-color": t.fill },
        ...
        function r(t, e) {
            ...
            return (
                ...
                (o.multiply = function (t) {
                    for (var e = new Array(o.getLength() + t.getLength() - 1), n = 0; n < o.getLength(); n += 1) for (var i = 0; i < t.getLength(); i += 1) e[n + i] ^= a.gexp(a.glog(o.get(n)) + a.glog(t.get(i)));
                    return r(e, 0);
                }),
                (o.mod = function (t) {
        ...
        var t = function (t, e) {
            var o = 236,
                ...
                E = function () {
                    for (var r = i.getPatternPosition(c), t = 0; t < r.length; t += 1)
                        for (var e = 0; e < r.length; e += 1) {
                            var n = r[t],
                                o = r[e];
                            if (null == s[n][o]) for (var a = -2; 2 >= a; a += 1) for (var u = -2; 2 >= u; u += 1) s[n + a][o + u] = -2 == a || 2 == a || -2 == u || 2 == u || (0 == a && 0 == u) ? !0 : !1;
                        }
                },
                k = function (r) {
                ...
                D = function (t, e) {
                    ...
                    for (var T = new Array(m), y = 0, s = 0; o > s; s += 1) for (var l = 0; l < e.length; l += 1) s < u[l].length && ((T[y] = u[l][s]), (y += 1));
                    for (var s = 0; a > s; s += 1) for (var l = 0; l < e.length; l += 1) s < f[l].length && ((T[y] = f[l][s]), (y += 1));
                    return T;
                },
                C = function (r, t, e) {
        ...
        var e = { MODE_NUMBER: 1, MODE_ALPHA_NUM: 2, MODE_8BIT_BYTE: 4, MODE_KANJI: 8 },
                        ...
                        for (var t = r.getModuleCount(), e = 0, n = 0; t > n; n += 1)
                            for (var o = 0; t > o; o += 1) {
                                for (var i = 0, a = r.isDark(n, o), u = -1; 1 >= u; u += 1)
                                    if (!(0 > n + u || n + u >= t)) for (var f = -1; 1 >= f; f += 1) 0 > o + f || o + f >= t || ((0 != u || 0 != f) && a == r.isDark(n + u, o + f) && (i += 1));
                                i > 5 && (e += 3 + i - 5);
                            }
            ...
            u = (function () {
                ...
                return (
                    (e.getRSBlocks = function (r, e) {
                        ...
                        for (var i = n.length / 3, a = new Array(), u = 0; i > u; u += 1) for (var f = n[3 * u + 0], l = n[3 * u + 1], c = n[3 * u + 2], g = 0; f > g; g += 1) a.push(t(l, c));
                        return a;
                    }),
                    e
                );
            ...
            g = function () {
                ...
                return (
                    ...
                    (o.flush = function () {
                        if ((t > 0 && (i(r << (6 - t)), (r = 0), (t = 0)), 0 != e % 3)) for (var o = 3 - (e % 3), a = 0; o > a; a += 1) n += "=";
                    }),
                    (o.toString = function () {
                        return n;
                    }),
